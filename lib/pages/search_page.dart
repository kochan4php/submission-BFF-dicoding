...
class _SearchPageState extends State<SearchPage> with Spacing {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: _buildAppBar(),
      body: BuildBodySearchPage(
        searchController: _searchController,
      ),
    );
  }

  AppBar _buildAppBar() => AppBar(title: const Text('Cari Restoran'));
...
class BuildBodySearchPage extends StatelessWidget {
  final TextEditingController searchController;

  const BuildBodySearchPage({
    super.key,
